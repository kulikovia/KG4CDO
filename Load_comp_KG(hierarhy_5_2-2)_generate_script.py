...
Max_Level_4 = 652330
Max_Level_5 = 1761293
Max_Objects = 4755492   #Model 1 lowest level
Max_Options = 4755492   #Model 1 lowest level
...
# Add Level 4 definitions
    ...
    # Add Level 5 definitions
    FileNum = 0
    i = 1
    k = 1
    while i <= Max_Level_5:
        FileNum = FileNum + 1
        f = open(Model_path + filename + "_Model1_level5_" + str(FileNum) + "_.nq", "at")
        f.write(header)
        f.write("\n<!--Objects definitions-->\n")
        while k <= Max_Step_1:
            body = str("<rdf:Description rdf:about='http://127.0.0.1/Core_1_Level_5_") + str(i) + str(
                "/'>\n<my:has_id>Core_1_Level_5_") + str(i) + str(
                "</my:has_id>\n<my:has_parent_id><rdf:Description rdf:about='http://127.0.0.1/Core_1_Level_4_") + str(random.randint(1, Max_Level_4)) + str(
                "/' /></my:has_parent_id>\n</rdf:Description>\n")
        ...
        f.close()
        spql.write(
            "\nLOAD <file:///" + str(SPARQL_path) + "/" + filename + "_Model1_level5_" + str(FileNum) + "_.nq>;\n")
        k = 1
...
# Add Level 5 definitions
    ...
    while i <= Max_Level_5:
        FileNum = FileNum + 1
        f = open(Model_path + filename + "_Model2_level5_" + str(FileNum) + "_.nq", "at")
        f.write(header)
        f.write("\n<!--Objects definitions-->\n")
        while k <= Max_Step_1:
            body = str("<rdf:Description rdf:about='http://127.0.0.1/Core_2_Level_5_") + str(i) + str(
                "/'>\n<my:has_id>Core_2_Level_5_") + str(i) + str(
                "</my:has_id>\n<my:has_parent_id><rdf:Description rdf:about='http://127.0.0.1/Core_2_Level_4_") + str(random.randint(1, Max_Level_4)) + str(
                "/' /></my:has_parent_id>\n</rdf:Description>\n")
        ...
        f.close()
        spql.write(
            "\nLOAD <file:///" + str(SPARQL_path) + "/" + filename + "_Model2_level5_" + str(FileNum) + "_.nq>;\n")
        k = 1
...
# Add Object  definitions
    ...
    while i <= Max_Objects:
        ...
        f.write("\n<!--Objects definitions-->\n")
        while k <= Max_Step_1:
            body = str("<rdf:Description rdf:about='http://127.0.0.1/Object_") + str(i) + str("/'>\n<my:has_id>Object_") + str(i) + str("</my:has_id>\n<my:has_parent_id><rdf:Description rdf:about='http://127.0.0.1/Core_1_Level_5_") + str(random.randint(1, Max_Level_5)) + str("/' /></my:has_parent_id>\n</rdf:Description>\n")
            f.write(body)
            i = i + 1
            k = k + 1
            if i > Max_Objects:
    ...
    while i <= Max_Options:
        ...
        while k <= Max_Step_1:
            body = str("<rdf:Description rdf:about='http://127.0.0.1/Option_") + str(i) + str(
                "/'>\n<my:has_id>Option_") + str(i) + str("</my:has_id>\n<my:has_parent_id><rdf:Description rdf:about='http://127.0.0.1/Core_2_Level_5_") + str(random.randint(1, Max_Level_5)) + str("/' /></my:has_parent_id>\n</rdf:Description>\n")
            f.write(body)
            i = i + 1
