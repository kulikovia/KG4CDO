...
Max_Level_2 = 682439
Max_Level_3 = 1842584
Max_Objects_1 = 4974977   #Model 1 lowest level
Max_Objects_2 = 4974977   #Model 2 lowest level
...
# Add Options  definitions
    ...
    while i <= Max_Objects_2:
        ...
        while k <= Max_Step_1:
            body = str("<rdf:Description rdf:about='http://127.0.0.1/Option_") + str(i) + str(
                "/'>\n<my:has_id>Option_") + str(i) + str("</my:has_id>\n<my:has_parent_id><rdf:Description rdf:about='http://127.0.0.1/Core_2_Level_3_") + str(random.randint(1, Max_Level_2)) + str("/' /></my:has_parent_id>\n</rdf:Description>\n")
            f.write(body)
            i = i + 1
 ...
 # Add Object-option links links Type-2  definitions
    ...
    while i <= Max_Level_2:
        ...
        while k <= Max_Step_1:
            body = str("<rdf:Description rdf:about='http://127.0.0.1/Core_1_Level_3_") + str(i) + str(
                "/'>\n<my:linked_to><rdf:Description rdf:about='http://127.0.0.1/Core_2_Level_3_") + str(i) + str("/' /></my:linked_to>\n</rdf:Description>\n")
            f.write(body)
            i = i + 1
            k = k + 1
