...
1.3.2. Private model generator of SSDS component for building a one-level model}} – Model_creation_one-level.py.
...
1.3.3. A set of CSDO test model generators in the format of multilevel knowledge graphs for analyzing SPARQL query execution time:
...
1.3.4. Generators of the test CSDO model in the format of one-level knowledge graph for analyzing the speed of SPARQL queries execution – Load_comp_KG(linear)_generate_script.py.
